...
module.exports = {
	...
	findExportData: function(idQuestionnaire, idSession, callback){
		var queryString = 'SELECT ID_ELEVE,SM.TELEPHONE_SMS as "Numtel", QU.NOM_QUESTION as "Question", SM.VALEUR_SMS as "Reponse" from SMS_RECU SM join EST_LIE E on E.ID_SMS = SM.ID_SMS join QUESTION QU on QU.ID_QUESTION=E.ID_QUESTION where QU.ID_QUESTIONNAIRE=? and E.ID_SESSION=?';
		console.log(queryString);
