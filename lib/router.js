...
module.exports = function(app){
	...
	app.get('/', [functions.notLogged], function(req, res, next) {
	  res.render('../view/login.ejs', { title: 'Amphiquizz - Connexion' });
	});
	...
	app.get('/fastquestion/:id', [functions.requireLogin], [functions.checkIdQuestion], function(req, res){
		res.render('../view/questionrapide.ejs', { title: 'Amphiquizz - Créer une question rapide' });
	});
	...
	app.get('/register', function(req, res){
		res.render('../view/register.ejs', { title: 'Amphiquizz - Créer un compte' });
	});
